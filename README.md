...
I build decision-support systems, optimization models, and applied analytics projects using **Python, C++, JavaScript, R, SQL, and scientific computing tools**.
...
Researcher focused on Operations Research, optimization, multi-criteria decision-making, and applied machine learning.  
I develop projects that connect mathematical modeling, data analysis, and computational methods to real-world decision problems.
